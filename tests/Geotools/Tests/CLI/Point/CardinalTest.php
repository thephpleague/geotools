...
use Geotools\CLI\Point\Cardinal;
...
class CardinalTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->application->add(new Cardinal());

        $this->command = $this->application->find('point:cardinal');
    ...
    public function testExecute()
    {
        ...
        $this->assertRegExp('/E/', $this->commandTester->getDisplay());
    }
}
